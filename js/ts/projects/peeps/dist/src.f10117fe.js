...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/events/Events.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Events() {
    ...
    this.eventMap = {}; // These are proxied via accessors on the callers, so
    // switch to arrow function to prevent this being orphaned.

    this.on = function (event, callback) {
      if (!_this.eventMap[event]) _this.eventMap[event] = [];

      _this.eventMap[event].push(callback);
    }; // These are proxied via accessors on the callers, so
    // switch to arrow function to prevent this being orphaned.


    this.trigger = function (event) {
      _this.eventMap[event] && _this.eventMap[event].forEach(function (cb) {
        return cb();
      });
    };
  }
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/api/API.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function API(domain) {
    ...
    this.fetch = function (id) {
      return axios_1.default.get(_this.url + "/" + _this.domain + "/" + id);
    };
  }

  API.prototype.save = function (data) {
    var fn;
    fn = data.id ? axios_1.default.put(this.url + "/" + this.domain + "/" + data.id, data) : axios_1.default.post(this.url + "/" + this.domain, data);
    return fn;
  };
...
function () {
  ...
  Attributes.prototype.set = function (props) {
    this.data = __assign(__assign({}, this.data), props);
...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    if (id) {
      this.api.fetch(this.getID()).then(function (response) {
  ...
  User.prototype.save = function () {
    ...
    this.api.save(this.attrs.getAll()).then(function (response) {
      return _this.set(response.data);
    }).catch(function (e) {
      return console.log(e.message);
    });
...
exports.User = User;
},{"../events/Events":"src/events/Events.ts","../api/API":"src/api/API.ts","./Attributes":"src/models/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
user.on('change', function () {
  return console.log('Something changed', user);
});
user.fetch();
user.set({
  name: 'roxy',
